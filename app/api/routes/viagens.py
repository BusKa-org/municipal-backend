...
rotas_bp = Blueprint("viagens", __name__)
...
@rotas_bp.route("/<int:viagem_id>/inscricao", methods=["GET"])
...
@rotas_bp.route("/<int:viagem_id>/iniciar", methods=["POST"])
...
@rotas_bp.route("/<int:viagem_id>/finalizar", methods=["POST"])
