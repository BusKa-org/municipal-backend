...
class OnibusListResource(Resource):
    ...
    def get(self):
        ...
        onibus_list = OnibusService.list_all(current_user_id)
    ...
    def post(self):
        ...
        onibus = OnibusService.create_onibus(current_user_id, data)
...
class OnibusResource(Resource):
    ...
    def get(self, id):
        ...
        current_user_id = get_jwt_identity()
        onibus = OnibusService.get_by_id(current_user_id, id)
    ...
    def delete(self, id):
        """Remove um ônibus"""
        current_user_id = get_jwt_identity()
        OnibusService.delete_onibus(current_user_id, id)
