...
def register_models(api):
    ...
    endereco_input = api.model('EnderecoInput', {
    ...
    create_request = api.model('AlunoCreateRequest', {
        ...
        'endereco_casa': fields.Nested(endereco_input, required=True, description='Endereço residencial')
    })
    
    update_request = api.model('AlunoUpdateRequest', {
    ...
    response = api.model('AlunoResponse', {
